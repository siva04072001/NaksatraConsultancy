...
urlpatterns = [
    ...
    path('subd/', views.subd, name='subd'),
    ...
    path('admindetail_ticket/<int:Id>/', views.admindetail_ticket, name='admindetail_ticket'),
    path('admininfo_ticket/<int:userId>/', views.admininfo_ticket, name='admininfo_ticket'),
    path('adminupdate_grant/<int:userId>/', views.adminupdate_grant, name='adminupdate_grant'),
    path('adminupdate_revoke/<int:userId>/', views.adminupdate_revoke, name='adminupdate_revoke'),
